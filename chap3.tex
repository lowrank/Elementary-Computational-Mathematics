...
\label{Thm: 3-Ort-Poly-Gen}
    The following recursive formula generates (unnormalized) orthogonal polynomials $p_j$.
...
\begin{enumerate}
    \item [$\circ$] Laguerre polynomial. The domain is $[0,\infty)$ and the Laguerre polynomials are defined by 
\begin{equation}
...
\item [$\circ$] Hermite polynomial. The domain is $(-\infty, \infty)$ and the Hermite polynomials are defined by 
\begin{equation}
