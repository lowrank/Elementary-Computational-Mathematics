...
\label{Lem: 3-Ric-Ext-Exp}
    ...
    $$h_j = \frac{\hbar}{t_j}$$
    for some adjustable parameter $\hbar$ and scaling constants $ 1 < t_0 < t_1<\dots < t_{n}$. Then 
...
% \end{equation}
The previous theorem also proves the following result for Shanks transformation.
\begin{theorem}
...
\subsection{Improving by Extrapolation}
